...
export const forbiddenHandler = (err: Error, req: Request, res: Response, next: NextFunction) => {
    if (err.status === 403) {
        res
            .status(403)
...
export const catchAllHandler = (err: Error, req: Request, res: Response, next: NextFunction) => {
    console.log(err)
